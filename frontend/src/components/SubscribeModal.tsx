                ...
                <div className="p-6 overflow-y-auto">
                    {step === 1 && (
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-4 p-4 rounded-xl border-2 transition-all ${billingType === 'PIX' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300'}`}
                            >
                                ...
                                <div className={`ml-auto w-5 h-5 rounded-full border-2 flex items-center justify-center ${billingType === 'PIX' ? 'border-orange-500' : 'border-gray-300'}`}>
                                    {billingType === 'PIX' && <div className="w-2.5 h-2.5 rounded-full bg-orange-500" />}
                                </div>
                            </button>
                        ...
                        <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-10 pr-4 font-mono text-gray-700 focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all outline-none"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 font-medium text-gray-700 focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all outline-none uppercase"
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    placeholder="MM"
                                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 font-mono text-center text-gray-700 focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all outline-none"
                            ...
                            <div className="pt-2">
                                ...
                                <div className="space-y-3">
                                    <input placeholder="Nome Completo" className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" value={holderInfo.name} onChange={e => setHolderInfo({ ...holderInfo, name: e.target.value })} />
                                    <input placeholder="CPF/CNPJ" className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" value={holderInfo.cpfCnpj} onChange={e => setHolderInfo({ ...holderInfo, cpfCnpj: e.target.value })} />
                                    <div className="flex gap-3">
                                        <input placeholder="CEP" className="w-1/2 bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" value={holderInfo.postalCode} onChange={e => setHolderInfo({ ...holderInfo, postalCode: e.target.value })} />
                                        <input placeholder="Número" className="w-1/2 bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" value={holderInfo.addressNumber} onChange={e => setHolderInfo({ ...holderInfo, addressNumber: e.target.value })} />
                                    </div>
                                    <input placeholder="Telefone" className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:bg-white focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" value={holderInfo.phone} onChange={e => setHolderInfo({ ...holderInfo, phone: e.target.value })} />
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {step === 3 && (
                        <div className="text-center space-y-6">
                            <div className="bg-orange-50 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto">
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className="text-orange-600 font-bold text-xs whitespace-nowrap hover:underline"
                                >
                                    COPIAR
                                </button>
                            </div>
